...
echo " 3) Abre el dashboard:  http://localhost:3000/dashboard  (o la URL que localtunnel te dé)/dashboard"
echo ""
echo "Ejemplo rápido para probar alertas (ejecuta mientras run16.sh corre):"
echo "  for i in \$(seq 1 8); do curl -s http://localhost:3000/ >/dev/null; sleep 1; done"
echo\n""
